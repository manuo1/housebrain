...
Gérée par l'IA conversationnelle — voir [ai_heating_duplication.md](./ai_heating_duplication.md). L'ancien endpoint `POST /api/heating/plans/duplicate/` (modes day/week, un seul appel synchrone) a été retiré.
